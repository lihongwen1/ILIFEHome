...
public class SuperEditText extends AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // a. 点击状态的左侧图标
        // 1. 获取资源ID
        ic_left_clickResID = typedArray.getResourceId(R.styleable.SuperEditText_ic_left_click, R.drawable.n_icon_personal);
        ...
        // b. 未点击状态的左侧图标
        // 1. 获取资源ID
        ic_left_unclickResID = typedArray.getResourceId(R.styleable.SuperEditText_ic_left_unclick, R.drawable.n_icon_personal);
        // 2. 根据资源ID获取图标资源（转化成Drawable对象）
        ...
        // 3. 分割线位置
        linePosition = typedArray.getInteger(R.styleable.SuperEditText_linePosition, 10);
        // 消除自带下划线
        setBackground(null);
    ...
    private void setDeleteIconVisible(boolean deleteVisible, boolean leftVisible) {
        ...
        setCompoundDrawables(leftVisible ? ic_left_click : ic_left_unclick, null,
                deleteVisible & isShowDelete ? ic_delete : null, null);
        color = leftVisible ? lineColor_click : lineColor_unclick;
        setTextColor(color);
        invalidate();
    }

    public void addOnInputEndListener(Consumer<String> consumer) {
