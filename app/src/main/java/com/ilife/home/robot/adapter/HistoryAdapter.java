...
public class HistoryAdapter extends BaseQuickAdapter<HistoryRecordBean, BaseViewHolder> {
    ...
    protected void convert(@NonNull BaseViewHolder holder, int position) {
        ...
        if (needDivide100) {
            holder.setText(R.id.tv_area, DataUtils.scale2(historyRecord.getCleanTotalArea() / 100f));
        } else {
            holder.setText(R.id.tv_area, DataUtils.scale2(historyRecord.getCleanTotalArea()));
        }
