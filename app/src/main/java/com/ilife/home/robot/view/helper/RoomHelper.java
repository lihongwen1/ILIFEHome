...
public class RoomHelper {
    ...
    public RoomHelper(MapView mapView) {
        ...
        String[] namesCn = UiUtil.getStringArray(R.array.default_room_name_key_cn);
        roomIcons.put(namesCn[0], decodeRoomBitmap(R.drawable.icon_name_living_room_orange));
        roomIcons.put(namesCn[1], decodeRoomBitmap(R.drawable.icon_name_restaurant_orange));
        roomIcons.put(namesCn[2], decodeRoomBitmap(R.drawable.icon_name_bedroom_orange));
        roomIcons.put(namesCn[3], decodeRoomBitmap(R.drawable.icon_name_kichten_orange));
        roomIcons.put(namesCn[4], decodeRoomBitmap(R.drawable.icon_name_bathe_orange));
        roomIcons.put(namesCn[5], decodeRoomBitmap(R.drawable.icon_name_study_orange));
        roomIcons.put(namesCn[6], decodeRoomBitmap(R.drawable.icon_name_laundry_orange));
        roomIcons.put(namesCn[7], decodeRoomBitmap(R.drawable.icon_name_rest_orange));
        roomIcons.put(namesCn[8], decodeRoomBitmap(R.drawable.icon_name_play_orange));
        roomIcons.put(namesCn[9], decodeRoomBitmap(R.drawable.icon_name_children_orange));
        roomIcons.put(namesCn[10], decodeRoomBitmap(R.drawable.icon_name_storage_orange));
        ...
        roomIconsWhite.put(namesCn[0], decodeRoomBitmap(R.drawable.icon_name_living_room_white));
        roomIconsWhite.put(namesCn[1], decodeRoomBitmap(R.drawable.icon_name_restaurant_white));
        roomIconsWhite.put(namesCn[2], decodeRoomBitmap(R.drawable.icon_name_bedroom_white));
        roomIconsWhite.put(namesCn[3], decodeRoomBitmap(R.drawable.icon_name_kichten_white));
        roomIconsWhite.put(namesCn[4], decodeRoomBitmap(R.drawable.icon_name_bathe_white));
        roomIconsWhite.put(namesCn[5], decodeRoomBitmap(R.drawable.icon_name_study_white));
        roomIconsWhite.put(namesCn[6], decodeRoomBitmap(R.drawable.icon_name_laundry_white));
        roomIconsWhite.put(namesCn[7], decodeRoomBitmap(R.drawable.icon_name_rest_white));
        roomIconsWhite.put(namesCn[8], decodeRoomBitmap(R.drawable.icon_name_play_white));
        roomIconsWhite.put(namesCn[9], decodeRoomBitmap(R.drawable.icon_name_children_white));
        roomIconsWhite.put(namesCn[10], decodeRoomBitmap(R.drawable.icon_name_storage_white));
