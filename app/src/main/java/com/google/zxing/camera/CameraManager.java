...
//      }
    ...
    public void requestAutoFocus(Handler handler, int message) {
        if (camera != null && previewing) {
            ...
            //MyLogger.d(TAG, "Requesting auto-focus callback");
...
//      int height = screenResolution.y * 7 / 10;
            int width = (int) getContext().getResources().getDimension(R.dimen.dp_260);
            int height = (int) getContext().getResources().getDimension(R.dimen.dp_260);
...
//      framingRect = new Rect(leftOffset, topOffset, leftOffset + width, topOffset + height);
//      MyLogger.d(TAG, "Calculated framing rect: " + framingRect);
//    }
//    return framingRect;
//  }
