...
public class AliEmailLoginActivity extends com.alibaba.sdk.android.openaccount.ui.ui.LoginActivity{
...
//                openAccountUIService.showEmailRegister(AliLoginActivity.this, getEmailRegisterCallback());
                openAccountUIService.showEmailRegister(AliEmailLoginActivity.this, AliRegisterEmaiActivity.class, getEmailRegisterCallback());
            });
        }
    ...
    private View.OnClickListener registerListenr = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.btn_register_phone) {//手机注册
                OpenAccountUIService openAccountUIService = OpenAccountSDK.getService(OpenAccountUIService.class);
//                openAccountUIService.showRegister(AliEmailLoginActivity.this, getRegisterLoginCallback());
                openAccountUIService.showRegister(AliEmailLoginActivity.this, AliRegisterActivity.class, getLoginCallback());
                registerSelectorDialogFragment.dismissAllowingStateLoss();
            } else if (v.getId() == R.id.btn_register_email) {//邮箱注册
                OpenAccountUIService openAccountUIService = OpenAccountSDK.getService(OpenAccountUIService.class);
//                openAccountUIService.showEmailRegister(AliEmailLoginActivity.this, getEmailRegisterCallback());
                openAccountUIService.showEmailRegister(AliEmailLoginActivity.this, AliRegisterEmaiActivity.class, getEmailRegisterCallback());
                registerSelectorDialogFragment.dismissAllowingStateLoss();
            }
        }
...
//        openAccountUIService.showEmailResetPassword(this, this.getEmailResetPasswordCallback());
    ...
    protected String getLayoutName() {
        return "activity_ali_email_login";
    }
}
